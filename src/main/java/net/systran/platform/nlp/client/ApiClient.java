...
import net.systran.platform.nlp.client.model.MultipartResponse;
import net.systran.platform.nlp.client.auth.Authentication;
import net.systran.platform.nlp.client.auth.HttpBasicAuth;
import net.systran.platform.nlp.client.auth.ApiKeyAuth;
import net.systran.platform.nlp.client.auth.OAuth;
...
public class ApiClient {
   ...
   */
  public ClientResponse invokeAPI(String path, String method, Map<String, Object> queryParams, Object body, Map<String, String> headerParams, Map<String, String> formParams, String accept, String contentType, String[] authNames) throws ApiException {
   ...
   * @param authNames The authentications to apply
   */
  private void updateParamsForAuth(String[] authNames, Map<String, Object> queryParams, Map<String, String> headerParams) {
